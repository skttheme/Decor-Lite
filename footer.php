...
<div id="footer-wrapper">
    	...
    	<div class="container footer">
        	 <div class="cols-3 widget-column-3">  
			   ...
			   <?php } 
			  		...
			  		if (!empty($contact_no)) { ?>
                <p><?php echo esc_html_e('Phone:','decor-lite');?> <?php echo esc_html($contact_no); ?></p>              
			   <?php }
			   		 $contact_mail = get_theme_mod('contact_mail');
			   		 if(!empty($contact_mail)){ 
			   		 echo esc_html_e('Email:','decor-lite');?>
        ...
        <?php } ?>
         <div class="copyright-wrapper">
        	<div class="container">
           		 <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','decor-lite');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/interior-wordpress-themes/');?>" target="_blank">
        <?php esc_html_e('SKT Interior Themes','decor-lite'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
