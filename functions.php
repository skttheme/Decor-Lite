...
define('DECOR_LITE_SKTTHEMES_URL','https://www.sktthemes.org');
define('DECOR_LITE_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.org/shop/decor-wordpress-theme/');
define('DECOR_LITE_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.org/shop/free-interior-furniture-wordpress-theme/');
define('DECOR_LITE__SKTTHEMES_THEME_DOC','http://sktthemesdemo.net/documentation/decor-documentation/');
define('DECOR_LITE_SKTTHEMES_LIVE_DEMO','https://www.sktperfectdemo.com/demos/decor/');
define('DECOR_LITE_SKTTHEMES_THEMES','https://www.sktthemes.org/themes/');
/**
...
add_action( 'tgmpa_register', 'decor_lite_register_required_plugins' );
 
function decor_lite_register_required_plugins() {
	$plugins = array(
		array(
			'name'      => 'SKT Templates',
			'slug'      => 'skt-templates',
